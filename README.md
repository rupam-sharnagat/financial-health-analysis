...
Data Extraction: Key financial figures (Total Revenue, Operating Expenses, Net Income, Total Assets, Total Liabilities, etc.) were compiled from annual reports.
Financial Analysis & Calculation: Key ratios and metrics were calculated for each year to assess performance across profitability, leverage, and liquidity.
Trend Visualization: Line charts were created to visualize the trends of key metrics over the five-year period.
Presentation: All findings were consolidated into a concise and insightful presentation.
Tools Used:
